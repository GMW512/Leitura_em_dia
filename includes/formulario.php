<main>
    ...
    <div class="mb-3 form-group">
        ...
        <input required type="password" name="senha" id="senha" class="form-control" value="<?=$obUsuario->senha?>">
        <div id="passwordHelpBlock" class="form-text text-light">
            Digite uma nova senha apenas se deseja alterá-la, por padrão ela será a mesma registrada.
        </div>
    </div>
